...
from routes import assessment_routes, auth_routes, classroom_routes, codespace_routes, coding_routes, notification_routes, template_routes, unit_routes, material_routes, test_routes, result_routes, user_routes
...
for router in [auth_routes.router, user_routes.router, classroom_routes.router, unit_routes.router, material_routes.router, assessment_routes.router, coding_routes.router, codespace_routes.router, notification_routes.router, template_routes.router, test_routes.router, result_routes.router]:
